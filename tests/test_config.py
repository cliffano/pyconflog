...
class TestConfig(unittest.TestCase):
    ...
    @patch("conflog.loaders.yaml_loader.load")
    @patch("conflog.loaders.ini_loader.load")
    def test_get_config_with_ini_overwritten_by_yaml_sequence(
        self, func_ini, func_yaml
    ):
    ...
    @patch("conflog.loaders.ini_loader.load")
    @patch("conflog.loaders.yaml_loader.load")
    def test_get_config_with_yaml_overwritten_by_ini_sequence(
        self, func_yaml, func_ini
    ):
