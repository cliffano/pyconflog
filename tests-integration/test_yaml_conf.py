...
class TestYamlConf(unittest.TestCase):
    ...
    def test_get_logger_with_single_conf_file(self):
        ...
        self.conflog = Conflog(conf_files=['tests-integration/fixtures/conflog.yaml'])
    ...
    def test_get_logger_with_single_conf_file_with_stream_handler_only(self):
        ...
        self.conflog = Conflog(conf_files=['tests-integration/fixtures/conflog-stream-only.yaml'])
        logger = self.conflog.get_logger(self.logger_name)
        logger.info('Some info log message')
    ...
    def test_get_logger_with_single_conf_file_with_empty_config(self):
        ...
        self.conflog = Conflog(conf_files=['tests-integration/fixtures/conflog-empty.yaml'])
        logger = self.conflog.get_logger(self.logger_name)
        logger.info('Some info log message')
