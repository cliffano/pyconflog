...
class TestJsonConf(unittest.TestCase):
    ...
    def test_get_logger_with_single_conf_file(self):
        ...
        self.conflog = Conflog(conf_files=['tests-integration/fixtures/conflog.json'])
        ...
        self.assertEqual(content,
                            '[JSON-CONFLOG] [someenv-someid] INFO Some info log message\n'\
                            '[JSON-CONFLOG] [someenv-someid] WARNING Some warning log message\n'\
                            '[JSON-CONFLOG] [someenv-someid] ERROR Some error log message\n'\
                            '[JSON-CONFLOG] [someenv-someid] CRITICAL Some critical log message\n')
    ...
    def test_get_logger_with_single_conf_file_with_stream_handler_only(self):
        ...
        self.conflog = Conflog(conf_files=['tests-integration/fixtures/conflog-stream-only.json'])
        logger = self.conflog.get_logger(self.logger_name)
        logger.info('Some info log message')
    ...
    def test_get_logger_with_single_conf_file_with_empty_config(self):
        ...
        self.conflog = Conflog(conf_files=['tests-integration/fixtures/conflog-empty.json'])
        logger = self.conflog.get_logger(self.logger_name)
        logger.info('Some info log message')
